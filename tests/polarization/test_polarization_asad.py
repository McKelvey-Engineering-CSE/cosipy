...
def test_convolve_spectrum():
    ...
    assert np.allclose(
        [
            polarization._azimuthal_angle_bins[5].rad, polarization._azimuthal_angle_bins[12].rad, 
...
def test_calculate_azimuthal_scattering_angle():
    ...
    assert np.allclose(
        [
            polarization.calculate_azimuthal_scattering_angle(0, 0).rad, polarization.calculate_azimuthal_scattering_angle(np.pi/5, 0).rad,
...
def test_polarization_fit():
    ...
    assert np.allclose(
        [azimuthal_angles[150].rad, azimuthal_angles[3275].rad, azimuthal_angles[5780].rad, azimuthal_angles[7050].rad], 
    ...
    assert np.allclose(
        [
            asad['uncertainties'][0][0], asad['uncertainties'][1][3], 
    ...
    assert np.allclose(
        [
            asad_int_bins['counts'][0], asad_int_bins['counts'][3], asad_int_bins['counts'][6], asad_int_bins['counts'][8]
        ], 
        [1114, 727, 587, 883])
    
    assert np.allclose(
        [
            asad_int_bins['uncertainties'][0][0], asad_int_bins['uncertainties'][1][3], 
    ...
    assert np.allclose(
        [
            asad_unpolarized['counts'][0], asad_unpolarized['counts'][3], 
            asad_unpolarized['counts'][6], asad_unpolarized['counts'][8]
        ], 
        [932.4137328357068, 906.8283258620892, 794.565967927462, 999.309350107182])
    
    assert np.allclose(
        [
            asad_unpolarized['uncertainties'][0][0], asad_unpolarized['uncertainties'][1][3], 
    ...
    assert np.allclose(
        [
            asad_unpolarized_int_bins['counts'][0], asad_unpolarized_int_bins['counts'][3], 
    ...
    assert np.allclose(
        [
            asad_unpolarized_int_bins['uncertainties'][0][0], asad_unpolarized_int_bins['uncertainties'][1][3], 
    ...
    assert np.allclose(
        [
            asad_unpolarized_bin_list['counts'][0], asad_unpolarized_bin_list['counts'][3], 
    ...
    assert np.allclose(
        [
            asad_unpolarized_bin_list['uncertainties'][0][0], asad_unpolarized_bin_list['uncertainties'][1][3], 
    ...
    assert np.allclose(
        [asad_polarized['counts'][0][0], asad_polarized['counts'][1][3], asad_polarized['counts'][2][6], asad_polarized['counts'][3][8]], 
        [229.70809288956985, 231.350661957243, 197.93859480541153, 243.6223882118957])
    
    assert np.allclose(
        [
            asad_polarized['uncertainties'][0][0][0], asad_polarized['uncertainties'][1][1][3], 
    ...
    assert np.allclose(
        [
            asad_polarized_int_bins['counts'][0][0], asad_polarized_int_bins['counts'][1][3], 
    ...
    assert np.allclose(
        [
            asad_polarized_int_bins['uncertainties'][0][0][0], asad_polarized_int_bins['uncertainties'][1][1][3], 
    ...
    assert np.allclose(
        [
            asad_polarized_bin_list['counts'][0][0], asad_polarized_bin_list['counts'][1][3], 
    ...
    assert np.allclose(
        [
            asad_polarized_bin_list['uncertainties'][0][0][0], asad_polarized_bin_list['uncertainties'][1][1][3], 
