...
print("alt,az,transient_id,n_src,n_bkg,lat_ml,lon_ml,err,exp_angdist,conf,time", flush=True)
...
for i, signal_file in enumerate(sources):
    ...
    if i >= n_warmup:
        ...
        print(f"{90-p},{a},{inst},{n_src},{n_bkg},{lat:.3f},{lon:.3f},{err:.3f},{exp_angdist:.3f},{conf:.4f},{t:.3f}", flush=True)
